# Generated for ReaImGui v0.5.3

from reaper_python import *


def ImGui_AcceptDragDropPayload(
    ctx, type, payloadOutNeedBig=None, payloadOutNeedBig_sz=None, flagsInOptional=None
):
    if not hasattr(ImGui_AcceptDragDropPayload, "func"):
        proc = rpr_getfp("ImGui_AcceptDragDropPayload")
        ImGui_AcceptDragDropPayload.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_char_p, c_int, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        rpr_packsc(type),
        rpr_packs(payloadOutNeedBig if payloadOutNeedBig != None else 0),
        c_int(payloadOutNeedBig_sz if payloadOutNeedBig_sz != None else 0),
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = ImGui_AcceptDragDropPayload.func(
        args[0], args[1], args[2], args[3], byref(args[4]) if args[4] != None else None
    )
    return rval, rpr_unpacks(args[2])


def ImGui_AcceptDragDropPayloadFiles(ctx, countOut=None, flagsInOptional=None):
    if not hasattr(ImGui_AcceptDragDropPayloadFiles, "func"):
        proc = rpr_getfp("ImGui_AcceptDragDropPayloadFiles")
        ImGui_AcceptDragDropPayloadFiles.func = CFUNCTYPE(
            c_bool, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        c_int(countOut if countOut != None else 0),
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = ImGui_AcceptDragDropPayloadFiles.func(
        args[0], byref(args[1]), byref(args[2]) if args[2] != None else None
    )
    return rval, int(args[1].value)


def ImGui_AcceptDragDropPayloadRGB(ctx, rgbOut=None, flagsInOptional=None):
    if not hasattr(ImGui_AcceptDragDropPayloadRGB, "func"):
        proc = rpr_getfp("ImGui_AcceptDragDropPayloadRGB")
        ImGui_AcceptDragDropPayloadRGB.func = CFUNCTYPE(
            c_bool, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        c_int(rgbOut if rgbOut != None else 0),
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = ImGui_AcceptDragDropPayloadRGB.func(
        args[0], byref(args[1]), byref(args[2]) if args[2] != None else None
    )
    return rval, int(args[1].value)


def ImGui_AcceptDragDropPayloadRGBA(ctx, rgbaOut=None, flagsInOptional=None):
    if not hasattr(ImGui_AcceptDragDropPayloadRGBA, "func"):
        proc = rpr_getfp("ImGui_AcceptDragDropPayloadRGBA")
        ImGui_AcceptDragDropPayloadRGBA.func = CFUNCTYPE(
            c_bool, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        c_int(rgbaOut if rgbaOut != None else 0),
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = ImGui_AcceptDragDropPayloadRGBA.func(
        args[0], byref(args[1]), byref(args[2]) if args[2] != None else None
    )
    return rval, int(args[1].value)
...
def ImGui_AttachFont(ctx, font):
    if not hasattr(ImGui_AttachFont, "func"):
        proc = rpr_getfp("ImGui_AttachFont")
        ImGui_AttachFont.func = CFUNCTYPE(None, c_void_p, c_void_p)(proc)
    args = (rpr_packp("ImGui_Context*", ctx), rpr_packp("ImGui_Font*", font))
    ImGui_AttachFont.func(args[0], args[1])


def ImGui_Begin(ctx, name, p_openInOut, flagsInOptional=None):
    if not hasattr(ImGui_Begin, "func"):
        proc = rpr_getfp("ImGui_Begin")
        ImGui_Begin.func = CFUNCTYPE(c_bool, c_void_p, c_char_p, c_void_p, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_BeginChild(
    ...
    args = (
        ...
        c_bool(borderInOptional) if borderInOptional != None else None,
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = ImGui_BeginChild.func(
        args[0],
        args[1],
...
def ImGui_BeginChildFrame(ctx, str_id, size_w, size_h, flagsInOptional=None):
    if not hasattr(ImGui_BeginChildFrame, "func"):
        ...
        ImGui_BeginChildFrame.func = CFUNCTYPE(
    ...
    rval = ImGui_BeginChildFrame.func(
        args[0], args[1], args[2], args[3], byref(args[4]) if args[4] != None else None
    )
    return rval
...
def ImGui_BeginCombo(ctx, label, preview_value, flagsInOptional=None):
    if not hasattr(ImGui_BeginCombo, "func"):
        ...
        ImGui_BeginCombo.func = CFUNCTYPE(
...
def ImGui_BeginDragDropSource(ctx, flagsInOptional=None):
    ...
    rval = ImGui_BeginDragDropSource.func(
...
def ImGui_BeginListBox(ctx, label, size_wInOptional=None, size_hInOptional=None):
    if not hasattr(ImGui_BeginListBox, "func"):
        ...
        ImGui_BeginListBox.func = CFUNCTYPE(
...
def ImGui_BeginPopupContextItem(ctx, str_idInOptional=None, popup_flagsInOptional=None):
    if not hasattr(ImGui_BeginPopupContextItem, "func"):
        ...
        ImGui_BeginPopupContextItem.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
    ...
    rval = ImGui_BeginPopupContextItem.func(
        args[0], args[1], byref(args[2]) if args[2] != None else None
    )
    return rval


def ImGui_BeginPopupContextWindow(
    ctx, str_idInOptional=None, popup_flagsInOptional=None
):
    if not hasattr(ImGui_BeginPopupContextWindow, "func"):
        proc = rpr_getfp("ImGui_BeginPopupContextWindow")
        ImGui_BeginPopupContextWindow.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
    ...
    rval = ImGui_BeginPopupContextWindow.func(
        args[0], args[1], byref(args[2]) if args[2] != None else None
    )
    return rval


def ImGui_BeginPopupModal(ctx, name, p_openInOut, flagsInOptional=None):
    if not hasattr(ImGui_BeginPopupModal, "func"):
        proc = rpr_getfp("ImGui_BeginPopupModal")
        ImGui_BeginPopupModal.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
    ...
    rval = ImGui_BeginPopupModal.func(
        args[0], args[1], byref(args[2]), byref(args[3]) if args[3] != None else None
    )
    return rval, int(args[2].value)
...
def ImGui_BeginTabBar(ctx, str_id, flagsInOptional=None):
    ...
    rval = ImGui_BeginTabBar.func(
        args[0], args[1], byref(args[2]) if args[2] != None else None
    )
    return rval


def ImGui_BeginTabItem(ctx, label, p_openInOut, flagsInOptional=None):
    if not hasattr(ImGui_BeginTabItem, "func"):
        proc = rpr_getfp("ImGui_BeginTabItem")
        ImGui_BeginTabItem.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
    ...
    rval = ImGui_BeginTabItem.func(
        args[0], args[1], byref(args[2]), byref(args[3]) if args[3] != None else None
    )
    return rval, int(args[2].value)


def ImGui_BeginTable(
    ctx,
    str_id,
    column,
    flagsInOptional=None,
    ...
    if not hasattr(ImGui_BeginTable, "func"):
        ...
        ImGui_BeginTable.func = CFUNCTYPE(
...
def ImGui_BeginTooltip(ctx):
    if not hasattr(ImGui_BeginTooltip, "func"):
        ...
        ImGui_BeginTooltip.func = CFUNCTYPE(None, c_void_p)(proc)
    args = (rpr_packp("ImGui_Context*", ctx),)
    ImGui_BeginTooltip.func(args[0])
...
def ImGui_Button(ctx, label, size_wInOptional=None, size_hInOptional=None):
    if not hasattr(ImGui_Button, "func"):
        ...
        ImGui_Button.func = CFUNCTYPE(c_bool, c_void_p, c_char_p, c_void_p, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_ButtonFlags_MouseButtonLeft():
    ...
    if not hasattr(ImGui_ButtonFlags_MouseButtonLeft, "cache"):
        ImGui_ButtonFlags_MouseButtonLeft.cache = (
            ImGui_ButtonFlags_MouseButtonLeft.func()
        )
...
def ImGui_ButtonFlags_MouseButtonMiddle():
    ...
    if not hasattr(ImGui_ButtonFlags_MouseButtonMiddle, "cache"):
        ImGui_ButtonFlags_MouseButtonMiddle.cache = (
            ImGui_ButtonFlags_MouseButtonMiddle.func()
        )
...
def ImGui_ButtonFlags_MouseButtonRight():
    ...
    if not hasattr(ImGui_ButtonFlags_MouseButtonRight, "cache"):
        ImGui_ButtonFlags_MouseButtonRight.cache = (
            ImGui_ButtonFlags_MouseButtonRight.func()
        )
...
def ImGui_CalcTextSize(
    ctx,
    text,
    wOut=None,
    hOut=None,
    hide_text_after_double_hashInOptional=None,
    wrap_widthInOptional=None,
):
    if not hasattr(ImGui_CalcTextSize, "func"):
        proc = rpr_getfp("ImGui_CalcTextSize")
        ImGui_CalcTextSize.func = CFUNCTYPE(
            None, c_void_p, c_char_p, c_void_p, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        rpr_packsc(text),
        c_double(wOut if wOut != None else 0),
        c_double(hOut if hOut != None else 0),
...
def ImGui_CaptureKeyboardFromApp(ctx, want_capture_keyboard_valueInOptional=None):
    if not hasattr(ImGui_CaptureKeyboardFromApp, "func"):
        proc = rpr_getfp("ImGui_CaptureKeyboardFromApp")
        ImGui_CaptureKeyboardFromApp.func = CFUNCTYPE(None, c_void_p, c_void_p)(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        c_bool(want_capture_keyboard_valueInOptional)
        if want_capture_keyboard_valueInOptional != None
        else None,
    )
    ImGui_CaptureKeyboardFromApp.func(
        args[0], byref(args[1]) if args[1] != None else None
    )
...
def ImGui_CheckboxFlags(ctx, label, flagsInOut, flags_value):
    if not hasattr(ImGui_CheckboxFlags, "func"):
        ...
        ImGui_CheckboxFlags.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_int
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        rpr_packsc(label),
...
def ImGui_CollapsingHeader(ctx, label, p_visibleInOut, flagsInOptional=None):
    if not hasattr(ImGui_CollapsingHeader, "func"):
        ...
        ImGui_CollapsingHeader.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        rpr_packsc(label),
        c_bool(p_visibleInOut),
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = ImGui_CollapsingHeader.func(
        args[0], args[1], byref(args[2]), byref(args[3]) if args[3] != None else None
    )
    return rval, int(args[2].value)


def ImGui_ColorButton(
    ctx,
    desc_id,
    col_rgba,
    flagsInOptional=None,
    ...
    if not hasattr(ImGui_ColorButton, "func"):
        ...
        ImGui_ColorButton.func = CFUNCTYPE(
...
def ImGui_ColorConvertHSVtoRGB(
    h, s, v, alphaInOptional=None, rOut=None, gOut=None, bOut=None
):
    if not hasattr(ImGui_ColorConvertHSVtoRGB, "func"):
        proc = rpr_getfp("ImGui_ColorConvertHSVtoRGB")
        ImGui_ColorConvertHSVtoRGB.func = CFUNCTYPE(
            c_int, c_double, c_double, c_double, c_void_p, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_double(h),
        c_double(s),
        c_double(v),
        c_double(alphaInOptional) if alphaInOptional != None else None,
        c_double(rOut if rOut != None else 0),
        c_double(gOut if gOut != None else 0),
        c_double(bOut if bOut != None else 0),
    )
    rval = ImGui_ColorConvertHSVtoRGB.func(
        args[0],
        args[1],
        args[2],
        byref(args[3]) if args[3] != None else None,
...
def ImGui_ColorConvertRGBtoHSV(
    r, g, b, alphaInOptional=None, hOut=None, sOut=None, vOut=None
):
    if not hasattr(ImGui_ColorConvertRGBtoHSV, "func"):
        proc = rpr_getfp("ImGui_ColorConvertRGBtoHSV")
        ImGui_ColorConvertRGBtoHSV.func = CFUNCTYPE(
            c_int, c_double, c_double, c_double, c_void_p, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        c_double(r),
        ...
        c_double(alphaInOptional) if alphaInOptional != None else None,
        c_double(hOut if hOut != None else 0),
        c_double(sOut if sOut != None else 0),
        c_double(vOut if vOut != None else 0),
    )
    rval = ImGui_ColorConvertRGBtoHSV.func(
        args[0],
        args[1],
        args[2],
        byref(args[3]) if args[3] != None else None,
...
def ImGui_ColorEdit3(ctx, label, col_rgbInOut, flagsInOptional=None):
    if not hasattr(ImGui_ColorEdit3, "func"):
        ...
        ImGui_ColorEdit3.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_ColorEdit4(ctx, label, col_rgbaInOut, flagsInOptional=None):
    if not hasattr(ImGui_ColorEdit4, "func"):
        ...
        ImGui_ColorEdit4.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_ColorEditFlags_AlphaPreview():
    ...
    if not hasattr(ImGui_ColorEditFlags_AlphaPreview, "cache"):
        ImGui_ColorEditFlags_AlphaPreview.cache = (
            ImGui_ColorEditFlags_AlphaPreview.func()
        )
...
def ImGui_ColorEditFlags_AlphaPreviewHalf():
    ...
    if not hasattr(ImGui_ColorEditFlags_AlphaPreviewHalf, "cache"):
        ImGui_ColorEditFlags_AlphaPreviewHalf.cache = (
            ImGui_ColorEditFlags_AlphaPreviewHalf.func()
        )
...
def ImGui_ColorEditFlags_NoSidePreview():
    ...
    if not hasattr(ImGui_ColorEditFlags_NoSidePreview, "cache"):
        ImGui_ColorEditFlags_NoSidePreview.cache = (
            ImGui_ColorEditFlags_NoSidePreview.func()
        )
...
def ImGui_ColorEditFlags_NoSmallPreview():
    ...
    if not hasattr(ImGui_ColorEditFlags_NoSmallPreview, "cache"):
        ImGui_ColorEditFlags_NoSmallPreview.cache = (
            ImGui_ColorEditFlags_NoSmallPreview.func()
        )
...
def ImGui_ColorEditFlags_PickerHueBar():
    ...
    if not hasattr(ImGui_ColorEditFlags_PickerHueBar, "cache"):
        ImGui_ColorEditFlags_PickerHueBar.cache = (
            ImGui_ColorEditFlags_PickerHueBar.func()
        )
...
def ImGui_ColorEditFlags_PickerHueWheel():
    ...
    if not hasattr(ImGui_ColorEditFlags_PickerHueWheel, "cache"):
        ImGui_ColorEditFlags_PickerHueWheel.cache = (
            ImGui_ColorEditFlags_PickerHueWheel.func()
        )
...
def ImGui_ColorEditFlags__OptionsDefault():
    if not hasattr(ImGui_ColorEditFlags__OptionsDefault, "func"):
        proc = rpr_getfp("ImGui_ColorEditFlags__OptionsDefault")
        ImGui_ColorEditFlags__OptionsDefault.func = CFUNCTYPE(c_int)(proc)
    if not hasattr(ImGui_ColorEditFlags__OptionsDefault, "cache"):
        ImGui_ColorEditFlags__OptionsDefault.cache = (
            ImGui_ColorEditFlags__OptionsDefault.func()
        )
    return ImGui_ColorEditFlags__OptionsDefault.cache
...
def ImGui_ColorPicker3(ctx, label, col_rgbInOut, flagsInOptional=None):
    if not hasattr(ImGui_ColorPicker3, "func"):
        ...
        ImGui_ColorPicker3.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
    ...
    rval = ImGui_ColorPicker3.func(
        args[0], args[1], byref(args[2]), byref(args[3]) if args[3] != None else None
    )
    return rval, int(args[2].value)


def ImGui_ColorPicker4(
    ...
    if not hasattr(ImGui_ColorPicker4, "func"):
        ...
        ImGui_ColorPicker4.func = CFUNCTYPE(
...
def ImGui_Combo(
    ...
    if not hasattr(ImGui_Combo, "func"):
        ...
        ImGui_Combo.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_char_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        rpr_packsc(label),
...
def ImGui_ConfigFlags_NavEnableKeyboard():
    ...
    if not hasattr(ImGui_ConfigFlags_NavEnableKeyboard, "cache"):
        ImGui_ConfigFlags_NavEnableKeyboard.cache = (
            ImGui_ConfigFlags_NavEnableKeyboard.func()
        )
...
def ImGui_ConfigFlags_NavEnableSetMousePos():
    ...
    if not hasattr(ImGui_ConfigFlags_NavEnableSetMousePos, "cache"):
        ImGui_ConfigFlags_NavEnableSetMousePos.cache = (
            ImGui_ConfigFlags_NavEnableSetMousePos.func()
        )
...
def ImGui_ConfigFlags_NoMouseCursorChange():
    ...
    if not hasattr(ImGui_ConfigFlags_NoMouseCursorChange, "cache"):
        ImGui_ConfigFlags_NoMouseCursorChange.cache = (
            ImGui_ConfigFlags_NoMouseCursorChange.func()
        )
...
def ImGui_ConfigFlags_NoSavedSettings():
    ...
    if not hasattr(ImGui_ConfigFlags_NoSavedSettings, "cache"):
        ImGui_ConfigFlags_NoSavedSettings.cache = (
            ImGui_ConfigFlags_NoSavedSettings.func()
        )
...
def ImGui_DragDouble(
    ...
    if not hasattr(ImGui_DragDouble, "func"):
        ...
        ImGui_DragDouble.func = CFUNCTYPE(
            c_bool,
            c_void_p,
            c_char_p,
            c_void_p,
...
def ImGui_DragDouble2(
    ...
    if not hasattr(ImGui_DragDouble2, "func"):
        ...
        ImGui_DragDouble2.func = CFUNCTYPE(
            c_bool,
            c_void_p,
            c_char_p,
            c_void_p,
...
def ImGui_DragDouble3(
    ...
    if not hasattr(ImGui_DragDouble3, "func"):
        ...
        ImGui_DragDouble3.func = CFUNCTYPE(
            c_bool,
            c_void_p,
            c_char_p,
            c_void_p,
...
def ImGui_DragDouble4(
    ...
    if not hasattr(ImGui_DragDouble4, "func"):
        ...
        ImGui_DragDouble4.func = CFUNCTYPE(
            c_bool,
            c_void_p,
            c_char_p,
            c_void_p,
...
def ImGui_DragDoubleN(
    ...
    if not hasattr(ImGui_DragDoubleN, "func"):
        ...
        ImGui_DragDoubleN.func = CFUNCTYPE(
            c_bool,
            c_void_p,
            c_char_p,
            c_void_p,
...
def ImGui_DragDropFlags_AcceptBeforeDelivery():
    ...
    if not hasattr(ImGui_DragDropFlags_AcceptBeforeDelivery, "cache"):
        ImGui_DragDropFlags_AcceptBeforeDelivery.cache = (
            ImGui_DragDropFlags_AcceptBeforeDelivery.func()
        )
...
def ImGui_DragDropFlags_AcceptNoDrawDefaultRect():
    ...
    if not hasattr(ImGui_DragDropFlags_AcceptNoDrawDefaultRect, "cache"):
        ImGui_DragDropFlags_AcceptNoDrawDefaultRect.cache = (
            ImGui_DragDropFlags_AcceptNoDrawDefaultRect.func()
        )
...
def ImGui_DragDropFlags_AcceptNoPreviewTooltip():
    ...
    if not hasattr(ImGui_DragDropFlags_AcceptNoPreviewTooltip, "cache"):
        ImGui_DragDropFlags_AcceptNoPreviewTooltip.cache = (
            ImGui_DragDropFlags_AcceptNoPreviewTooltip.func()
        )
...
def ImGui_DragDropFlags_AcceptPeekOnly():
    ...
    if not hasattr(ImGui_DragDropFlags_AcceptPeekOnly, "cache"):
        ImGui_DragDropFlags_AcceptPeekOnly.cache = (
            ImGui_DragDropFlags_AcceptPeekOnly.func()
        )
...
def ImGui_DragDropFlags_SourceAllowNullID():
    ...
    if not hasattr(ImGui_DragDropFlags_SourceAllowNullID, "cache"):
        ImGui_DragDropFlags_SourceAllowNullID.cache = (
            ImGui_DragDropFlags_SourceAllowNullID.func()
        )
...
def ImGui_DragDropFlags_SourceAutoExpirePayload():
    ...
    if not hasattr(ImGui_DragDropFlags_SourceAutoExpirePayload, "cache"):
        ImGui_DragDropFlags_SourceAutoExpirePayload.cache = (
            ImGui_DragDropFlags_SourceAutoExpirePayload.func()
        )
...
def ImGui_DragDropFlags_SourceNoDisableHover():
    ...
    if not hasattr(ImGui_DragDropFlags_SourceNoDisableHover, "cache"):
        ImGui_DragDropFlags_SourceNoDisableHover.cache = (
            ImGui_DragDropFlags_SourceNoDisableHover.func()
        )
...
def ImGui_DragDropFlags_SourceNoHoldToOpenOthers():
    ...
    if not hasattr(ImGui_DragDropFlags_SourceNoHoldToOpenOthers, "cache"):
        ImGui_DragDropFlags_SourceNoHoldToOpenOthers.cache = (
            ImGui_DragDropFlags_SourceNoHoldToOpenOthers.func()
        )
...
def ImGui_DragDropFlags_SourceNoPreviewTooltip():
    ...
    if not hasattr(ImGui_DragDropFlags_SourceNoPreviewTooltip, "cache"):
        ImGui_DragDropFlags_SourceNoPreviewTooltip.cache = (
            ImGui_DragDropFlags_SourceNoPreviewTooltip.func()
        )
    return ImGui_DragDropFlags_SourceNoPreviewTooltip.cache


def ImGui_DragFloatRange2(
    ctx,
    label,
    v_current_minInOut,
    v_current_maxInOut,
    ...
    if not hasattr(ImGui_DragFloatRange2, "func"):
        ...
        ImGui_DragFloatRange2.func = CFUNCTYPE(
            c_bool,
            c_void_p,
            c_char_p,
            c_void_p,
    ...
    rval = ImGui_DragFloatRange2.func(
        args[0],
        args[1],
        byref(args[2]),
        byref(args[3]),
...
def ImGui_DragIntRange2(
    ...
    if not hasattr(ImGui_DragIntRange2, "func"):
        ...
        ImGui_DragIntRange2.func = CFUNCTYPE(
            c_bool,
            c_void_p,
            c_char_p,
            c_void_p,
...
def ImGui_DrawFlags_RoundCornersBottom():
    ...
    if not hasattr(ImGui_DrawFlags_RoundCornersBottom, "cache"):
        ImGui_DrawFlags_RoundCornersBottom.cache = (
            ImGui_DrawFlags_RoundCornersBottom.func()
        )
...
def ImGui_DrawFlags_RoundCornersBottomLeft():
    ...
    if not hasattr(ImGui_DrawFlags_RoundCornersBottomLeft, "cache"):
        ImGui_DrawFlags_RoundCornersBottomLeft.cache = (
            ImGui_DrawFlags_RoundCornersBottomLeft.func()
        )
...
def ImGui_DrawFlags_RoundCornersBottomRight():
    ...
    if not hasattr(ImGui_DrawFlags_RoundCornersBottomRight, "cache"):
        ImGui_DrawFlags_RoundCornersBottomRight.cache = (
            ImGui_DrawFlags_RoundCornersBottomRight.func()
        )
...
def ImGui_DrawFlags_RoundCornersRight():
    ...
    if not hasattr(ImGui_DrawFlags_RoundCornersRight, "cache"):
        ImGui_DrawFlags_RoundCornersRight.cache = (
            ImGui_DrawFlags_RoundCornersRight.func()
        )
...
def ImGui_DrawFlags_RoundCornersTopLeft():
    ...
    if not hasattr(ImGui_DrawFlags_RoundCornersTopLeft, "cache"):
        ImGui_DrawFlags_RoundCornersTopLeft.cache = (
            ImGui_DrawFlags_RoundCornersTopLeft.func()
        )
...
def ImGui_DrawFlags_RoundCornersTopRight():
    ...
    if not hasattr(ImGui_DrawFlags_RoundCornersTopRight, "cache"):
        ImGui_DrawFlags_RoundCornersTopRight.cache = (
            ImGui_DrawFlags_RoundCornersTopRight.func()
        )
    return ImGui_DrawFlags_RoundCornersTopRight.cache


def ImGui_DrawList_AddBezierCubic(
    draw_list,
    p1_x,
    p1_y,
    p2_x,
    ...
    if not hasattr(ImGui_DrawList_AddBezierCubic, "func"):
        ...
        ImGui_DrawList_AddBezierCubic.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
    ...
    args = (
        rpr_packp("ImGui_DrawList*", draw_list),
        c_double(p1_x),
        c_double(p1_y),
        c_double(p2_x),
        c_double(p2_y),
    ...
    ImGui_DrawList_AddBezierCubic.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def ImGui_DrawList_AddBezierQuadratic(
    draw_list,
    p1_x,
    p1_y,
    p2_x,
    ...
    if not hasattr(ImGui_DrawList_AddBezierQuadratic, "func"):
        ...
        ImGui_DrawList_AddBezierQuadratic.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
    ...
    ImGui_DrawList_AddBezierQuadratic.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def ImGui_DrawList_AddCircle(
    ...
    if not hasattr(ImGui_DrawList_AddCircle, "func"):
        ...
        ImGui_DrawList_AddCircle.func = CFUNCTYPE(
...
def ImGui_DrawList_AddCircleFilled(
    ...
    if not hasattr(ImGui_DrawList_AddCircleFilled, "func"):
        ...
        ImGui_DrawList_AddCircleFilled.func = CFUNCTYPE(
    ...
    ImGui_DrawList_AddCircleFilled.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def ImGui_DrawList_AddConvexPolyFilled(draw_list, points, num_points, col_rgba):
    if not hasattr(ImGui_DrawList_AddConvexPolyFilled, "func"):
        proc = rpr_getfp("ImGui_DrawList_AddConvexPolyFilled")
        ImGui_DrawList_AddConvexPolyFilled.func = CFUNCTYPE(
            None, c_void_p, c_void_p, c_int, c_int
        )(proc)
    args = (
        rpr_packp("ImGui_DrawList*", draw_list),
        rpr_packp("reaper_array*", points),
        c_int(num_points),
        c_int(col_rgba),
    )
    ImGui_DrawList_AddConvexPolyFilled.func(args[0], args[1], args[2], args[3])


def ImGui_DrawList_AddLine(
    ...
    if not hasattr(ImGui_DrawList_AddLine, "func"):
        ...
        ImGui_DrawList_AddLine.func = CFUNCTYPE(
...
def ImGui_DrawList_AddNgon(
    ...
    if not hasattr(ImGui_DrawList_AddNgon, "func"):
        ...
        ImGui_DrawList_AddNgon.func = CFUNCTYPE(
...
def ImGui_DrawList_AddNgonFilled(
    ...
    if not hasattr(ImGui_DrawList_AddNgonFilled, "func"):
        ...
        ImGui_DrawList_AddNgonFilled.func = CFUNCTYPE(
    ...
    ImGui_DrawList_AddNgonFilled.func(
...
def ImGui_DrawList_AddPolyline(draw_list, points, col_rgba, flags, thickness):
    if not hasattr(ImGui_DrawList_AddPolyline, "func"):
        ...
        ImGui_DrawList_AddPolyline.func = CFUNCTYPE(
...
def ImGui_DrawList_AddQuad(
    ...
    if not hasattr(ImGui_DrawList_AddQuad, "func"):
        ...
        ImGui_DrawList_AddQuad.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
...
def ImGui_DrawList_AddQuadFilled(
    ...
    if not hasattr(ImGui_DrawList_AddQuadFilled, "func"):
        ...
        ImGui_DrawList_AddQuadFilled.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
    ...
    ImGui_DrawList_AddQuadFilled.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def ImGui_DrawList_AddRect(
    ...
    if not hasattr(ImGui_DrawList_AddRect, "func"):
        ...
        ImGui_DrawList_AddRect.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
...
def ImGui_DrawList_AddRectFilled(
    draw_list,
    p_min_x,
    p_min_y,
    p_max_x,
    ...
    if not hasattr(ImGui_DrawList_AddRectFilled, "func"):
        ...
        ImGui_DrawList_AddRectFilled.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
    ...
    ImGui_DrawList_AddRectFilled.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def ImGui_DrawList_AddRectFilledMultiColor(
    draw_list,
    p_min_x,
    p_min_y,
    p_max_x,
    ...
    if not hasattr(ImGui_DrawList_AddRectFilledMultiColor, "func"):
        ...
        ImGui_DrawList_AddRectFilledMultiColor.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
    ...
    ImGui_DrawList_AddRectFilledMultiColor.func(
...
def ImGui_DrawList_AddText(draw_list, x, y, col_rgba, text):
    if not hasattr(ImGui_DrawList_AddText, "func"):
        ...
        ImGui_DrawList_AddText.func = CFUNCTYPE(
...
def ImGui_DrawList_AddTextEx(
    ...
    text,
    wrap_widthInOptional=None,
    cpu_fine_clip_rect_xInOptional=None,
    cpu_fine_clip_rect_yInOptional=None,
    cpu_fine_clip_rect_wInOptional=None,
    cpu_fine_clip_rect_hInOptional=None,
):
    if not hasattr(ImGui_DrawList_AddTextEx, "func"):
        proc = rpr_getfp("ImGui_DrawList_AddTextEx")
        ImGui_DrawList_AddTextEx.func = CFUNCTYPE(
            None,
            c_void_p,
            c_void_p,
            c_double,
    ...
    args = (
        ...
        rpr_packsc(text),
        c_double(wrap_widthInOptional) if wrap_widthInOptional != None else None,
        c_double(cpu_fine_clip_rect_xInOptional)
        if cpu_fine_clip_rect_xInOptional != None
        else None,
        c_double(cpu_fine_clip_rect_yInOptional)
        if cpu_fine_clip_rect_yInOptional != None
        else None,
        c_double(cpu_fine_clip_rect_wInOptional)
        if cpu_fine_clip_rect_wInOptional != None
        else None,
        c_double(cpu_fine_clip_rect_hInOptional)
        if cpu_fine_clip_rect_hInOptional != None
        else None,
    )
    ImGui_DrawList_AddTextEx.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def ImGui_DrawList_AddTriangle(
    ...
    if not hasattr(ImGui_DrawList_AddTriangle, "func"):
        ...
        ImGui_DrawList_AddTriangle.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
    ...
    ImGui_DrawList_AddTriangle.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def ImGui_DrawList_AddTriangleFilled(
    draw_list, p1_x, p1_y, p2_x, p2_y, p3_x, p3_y, col_rgba
):
    if not hasattr(ImGui_DrawList_AddTriangleFilled, "func"):
        proc = rpr_getfp("ImGui_DrawList_AddTriangleFilled")
        ImGui_DrawList_AddTriangleFilled.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
    ...
    ImGui_DrawList_AddTriangleFilled.func(
        args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7]
    )


def ImGui_DrawList_PathArcTo(
    ...
    if not hasattr(ImGui_DrawList_PathArcTo, "func"):
        ...
        ImGui_DrawList_PathArcTo.func = CFUNCTYPE(
...
def ImGui_DrawList_PathArcToFast(
    ...
    if not hasattr(ImGui_DrawList_PathArcToFast, "func"):
        ...
        ImGui_DrawList_PathArcToFast.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_double, c_int, c_int
        )(proc)
    args = (
        rpr_packp("ImGui_DrawList*", draw_list),
    ...
    ImGui_DrawList_PathArcToFast.func(
        args[0], args[1], args[2], args[3], args[4], args[5]
    )


def ImGui_DrawList_PathBezierCubicCurveTo(
    ...
    if not hasattr(ImGui_DrawList_PathBezierCubicCurveTo, "func"):
        ...
        ImGui_DrawList_PathBezierCubicCurveTo.func = CFUNCTYPE(
            None,
            c_void_p,
            c_double,
            c_double,
    ...
    ImGui_DrawList_PathBezierCubicCurveTo.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def ImGui_DrawList_PathBezierQuadraticCurveTo(
    ...
    if not hasattr(ImGui_DrawList_PathBezierQuadraticCurveTo, "func"):
        ...
        ImGui_DrawList_PathBezierQuadraticCurveTo.func = CFUNCTYPE(
    ...
    ImGui_DrawList_PathBezierQuadraticCurveTo.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def ImGui_DrawList_PathLineTo(draw_list, pos_x, pos_y):
    if not hasattr(ImGui_DrawList_PathLineTo, "func"):
        ...
        ImGui_DrawList_PathLineTo.func = CFUNCTYPE(None, c_void_p, c_double, c_double)(
            proc
        )
...
def ImGui_DrawList_PathRect(
    ...
    if not hasattr(ImGui_DrawList_PathRect, "func"):
        ...
        ImGui_DrawList_PathRect.func = CFUNCTYPE(
...
def ImGui_DrawList_PathStroke(
    ...
    if not hasattr(ImGui_DrawList_PathStroke, "func"):
        ...
        ImGui_DrawList_PathStroke.func = CFUNCTYPE(
    ...
    ImGui_DrawList_PathStroke.func(
        args[0],
        args[1],
        byref(args[2]) if args[2] != None else None,
        byref(args[3]) if args[3] != None else None,
...
def ImGui_DrawList_PushClipRect(
    draw_list,
    clip_rect_min_x,
    clip_rect_min_y,
    clip_rect_max_x,
    ...
    if not hasattr(ImGui_DrawList_PushClipRect, "func"):
        ...
        ImGui_DrawList_PushClipRect.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_double, c_double, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_DrawList*", draw_list),
    ...
    ImGui_DrawList_PushClipRect.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def ImGui_FocusedFlags_RootAndChildWindows():
    ...
    if not hasattr(ImGui_FocusedFlags_RootAndChildWindows, "cache"):
        ImGui_FocusedFlags_RootAndChildWindows.cache = (
            ImGui_FocusedFlags_RootAndChildWindows.func()
        )
...
def ImGui_GetConfigFlags(ctx):
    if not hasattr(ImGui_GetConfigFlags, "func"):
        proc = rpr_getfp("ImGui_GetConfigFlags")
        ImGui_GetConfigFlags.func = CFUNCTYPE(c_int, c_void_p)(proc)
    args = (rpr_packp("ImGui_Context*", ctx),)
    rval = ImGui_GetConfigFlags.func(args[0])
    return rval


def ImGui_GetContentRegionAvail(ctx, xOut=None, yOut=None):
    if not hasattr(ImGui_GetContentRegionAvail, "func"):
        proc = rpr_getfp("ImGui_GetContentRegionAvail")
        ImGui_GetContentRegionAvail.func = CFUNCTYPE(
            None, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        c_double(xOut if xOut != None else 0),
        c_double(yOut if yOut != None else 0),
    )
    ImGui_GetContentRegionAvail.func(args[0], byref(args[1]), byref(args[2]))
    return float(args[1].value), float(args[2].value)


def ImGui_GetContentRegionMax(ctx, xOut=None, yOut=None):
    if not hasattr(ImGui_GetContentRegionMax, "func"):
        proc = rpr_getfp("ImGui_GetContentRegionMax")
        ImGui_GetContentRegionMax.func = CFUNCTYPE(None, c_void_p, c_void_p, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_GetCursorPos(ctx, xOut=None, yOut=None):
...
def ImGui_GetCursorScreenPos(ctx, xOut=None, yOut=None):
    if not hasattr(ImGui_GetCursorScreenPos, "func"):
        proc = rpr_getfp("ImGui_GetCursorScreenPos")
        ImGui_GetCursorScreenPos.func = CFUNCTYPE(None, c_void_p, c_void_p, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_GetCursorStartPos(ctx, xOut=None, yOut=None):
    if not hasattr(ImGui_GetCursorStartPos, "func"):
        proc = rpr_getfp("ImGui_GetCursorStartPos")
        ImGui_GetCursorStartPos.func = CFUNCTYPE(None, c_void_p, c_void_p, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_GetDragDropPayload(
    ctx,
    typeOut=None,
    typeOut_sz=None,
    payloadOutNeedBig=None,
    payloadOutNeedBig_sz=None,
    is_previewOut=None,
    is_deliveryOut=None,
):
    if not hasattr(ImGui_GetDragDropPayload, "func"):
        proc = rpr_getfp("ImGui_GetDragDropPayload")
        ImGui_GetDragDropPayload.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_int, c_char_p, c_int, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        rpr_packs(typeOut if typeOut != None else 0),
        c_int(typeOut_sz if typeOut_sz != None else 0),
        rpr_packs(payloadOutNeedBig if payloadOutNeedBig != None else 0),
        c_int(payloadOutNeedBig_sz if payloadOutNeedBig_sz != None else 0),
        c_bool(is_previewOut if is_previewOut != None else 0),
        c_bool(is_deliveryOut if is_deliveryOut != None else 0),
    )
    rval = ImGui_GetDragDropPayload.func(
...
def ImGui_GetDragDropPayloadFile(ctx, index, filenameOut=None, filenameOut_sz=None):
    if not hasattr(ImGui_GetDragDropPayloadFile, "func"):
        proc = rpr_getfp("ImGui_GetDragDropPayloadFile")
        ImGui_GetDragDropPayloadFile.func = CFUNCTYPE(
            c_bool, c_void_p, c_int, c_char_p, c_int
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        c_int(index),
        rpr_packs(filenameOut if filenameOut != None else 0),
        c_int(filenameOut_sz if filenameOut_sz != None else 0),
    )
...
def ImGui_GetInputQueueCharacter(ctx, idx, unicode_charOut=None):
    if not hasattr(ImGui_GetInputQueueCharacter, "func"):
        proc = rpr_getfp("ImGui_GetInputQueueCharacter")
        ImGui_GetInputQueueCharacter.func = CFUNCTYPE(
            c_bool, c_void_p, c_int, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        c_int(idx),
        c_int(unicode_charOut if unicode_charOut != None else 0),
    )
    rval = ImGui_GetInputQueueCharacter.func(args[0], args[1], byref(args[2]))
    return rval, int(args[2].value)


def ImGui_GetItemRectMax(ctx, xOut=None, yOut=None):
...
def ImGui_GetItemRectMin(ctx, xOut=None, yOut=None):
...
def ImGui_GetItemRectSize(ctx, wOut=None, hOut=None):
...
def ImGui_GetKeyDownDuration(ctx, key_code):
    ...
    args = (rpr_packp("ImGui_Context*", ctx), c_int(key_code))
...
def ImGui_GetMouseClickedPos(ctx, button, xOut=None, yOut=None):
    if not hasattr(ImGui_GetMouseClickedPos, "func"):
        proc = rpr_getfp("ImGui_GetMouseClickedPos")
        ImGui_GetMouseClickedPos.func = CFUNCTYPE(
            None, c_void_p, c_int, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_GetMouseDelta(ctx, xOut=None, yOut=None):
...
def ImGui_GetMouseDragDelta(
    ctx, xOut=None, yOut=None, buttonInOptional=None, lock_thresholdInOptional=None
):
    if not hasattr(ImGui_GetMouseDragDelta, "func"):
        proc = rpr_getfp("ImGui_GetMouseDragDelta")
        ImGui_GetMouseDragDelta.func = CFUNCTYPE(
...
def ImGui_GetMousePos(ctx, xOut=None, yOut=None):
...
def ImGui_GetMousePosOnOpeningCurrentPopup(ctx, xOut=None, yOut=None):
    if not hasattr(ImGui_GetMousePosOnOpeningCurrentPopup, "func"):
        proc = rpr_getfp("ImGui_GetMousePosOnOpeningCurrentPopup")
        ImGui_GetMousePosOnOpeningCurrentPopup.func = CFUNCTYPE(
            None, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_GetMouseWheel(ctx, verticalOut=None, horizontalOut=None):
    ...
    args = (
        rpr_packp("ImGui_Context*", ctx),
        c_double(verticalOut if verticalOut != None else 0),
        c_double(horizontalOut if horizontalOut != None else 0),
    )
...
def ImGui_GetStyleColorName(idx):
    if not hasattr(ImGui_GetStyleColorName, "func"):
        proc = rpr_getfp("ImGui_GetStyleColorName")
        ImGui_GetStyleColorName.func = CFUNCTYPE(c_char_p, c_int)(proc)
    args = (c_int(idx),)
    rval = ImGui_GetStyleColorName.func(args[0])
    return str(rval.decode())


def ImGui_GetStyleVar(ctx, var_idx, val1Out=None, val2Out=None):
    if not hasattr(ImGui_GetStyleVar, "func"):
        proc = rpr_getfp("ImGui_GetStyleVar")
        ImGui_GetStyleVar.func = CFUNCTYPE(None, c_void_p, c_int, c_void_p, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Context*", ctx),
        c_int(var_idx),
        c_double(val1Out if val1Out != None else 0),
        c_double(val2Out if val2Out != None else 0),
    )
...
def ImGui_GetVersion(
    imgui_versionOut=None,
    imgui_versionOut_sz=None,
    reaimgui_versionOut=None,
    reaimgui_versionOut_sz=None,
):
    if not hasattr(ImGui_GetVersion, "func"):
        proc = rpr_getfp("ImGui_GetVersion")
        ImGui_GetVersion.func = CFUNCTYPE(None, c_char_p, c_int, c_char_p, c_int)(proc)
    args = (
        rpr_packs(imgui_versionOut if imgui_versionOut != None else 0),
        c_int(imgui_versionOut_sz if imgui_versionOut_sz != None else 0),
        rpr_packs(reaimgui_versionOut if reaimgui_versionOut != None else 0),
        c_int(reaimgui_versionOut_sz if reaimgui_versionOut_sz != None else 0),
    )
    ImGui_GetVersion.func(args[0], args[1], args[2], args[3])
    return rpr_unpacks(args[0]), rpr_unpacks(args[2])


def ImGui_GetWindowContentRegionMax(ctx, xOut=None, yOut=None):
    if not hasattr(ImGui_GetWindowContentRegionMax, "func"):
        proc = rpr_getfp("ImGui_GetWindowContentRegionMax")
        ImGui_GetWindowContentRegionMax.func = CFUNCTYPE(
            None, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_GetWindowContentRegionMin(ctx, xOut=None, yOut=None):
    if not hasattr(ImGui_GetWindowContentRegionMin, "func"):
        proc = rpr_getfp("ImGui_GetWindowContentRegionMin")
        ImGui_GetWindowContentRegionMin.func = CFUNCTYPE(
            None, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_GetWindowContentRegionWidth(ctx):
    if not hasattr(ImGui_GetWindowContentRegionWidth, "func"):
        proc = rpr_getfp("ImGui_GetWindowContentRegionWidth")
        ImGui_GetWindowContentRegionWidth.func = CFUNCTYPE(c_double, c_void_p)(proc)
    args = (rpr_packp("ImGui_Context*", ctx),)
    rval = ImGui_GetWindowContentRegionWidth.func(args[0])
    return rval
...
def ImGui_GetWindowPos(ctx, xOut=None, yOut=None):
...
def ImGui_GetWindowSize(ctx, wOut=None, hOut=None):
...
def ImGui_HoveredFlags_AllowWhenBlockedByActiveItem():
    ...
    if not hasattr(ImGui_HoveredFlags_AllowWhenBlockedByActiveItem, "cache"):
        ImGui_HoveredFlags_AllowWhenBlockedByActiveItem.cache = (
            ImGui_HoveredFlags_AllowWhenBlockedByActiveItem.func()
        )
...
def ImGui_HoveredFlags_AllowWhenBlockedByPopup():
    ...
    if not hasattr(ImGui_HoveredFlags_AllowWhenBlockedByPopup, "cache"):
        ImGui_HoveredFlags_AllowWhenBlockedByPopup.cache = (
            ImGui_HoveredFlags_AllowWhenBlockedByPopup.func()
        )
...
def ImGui_HoveredFlags_AllowWhenDisabled():
    ...
    if not hasattr(ImGui_HoveredFlags_AllowWhenDisabled, "cache"):
        ImGui_HoveredFlags_AllowWhenDisabled.cache = (
            ImGui_HoveredFlags_AllowWhenDisabled.func()
        )
...
def ImGui_HoveredFlags_AllowWhenOverlapped():
    ...
    if not hasattr(ImGui_HoveredFlags_AllowWhenOverlapped, "cache"):
        ImGui_HoveredFlags_AllowWhenOverlapped.cache = (
            ImGui_HoveredFlags_AllowWhenOverlapped.func()
        )
...
def ImGui_HoveredFlags_RootAndChildWindows():
    ...
    if not hasattr(ImGui_HoveredFlags_RootAndChildWindows, "cache"):
        ImGui_HoveredFlags_RootAndChildWindows.cache = (
            ImGui_HoveredFlags_RootAndChildWindows.func()
        )
...
def ImGui_InputDouble(
    ...
    if not hasattr(ImGui_InputDouble, "func"):
        ...
        ImGui_InputDouble.func = CFUNCTYPE(
...
def ImGui_InputDouble2(
    ...
    if not hasattr(ImGui_InputDouble2, "func"):
        ...
        ImGui_InputDouble2.func = CFUNCTYPE(
...
def ImGui_InputDouble3(
    ...
    if not hasattr(ImGui_InputDouble3, "func"):
        ...
        ImGui_InputDouble3.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p, c_void_p, c_char_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_InputDouble4(
    ...
    if not hasattr(ImGui_InputDouble4, "func"):
        ...
        ImGui_InputDouble4.func = CFUNCTYPE(
            c_bool,
            c_void_p,
            c_char_p,
            c_void_p,
...
def ImGui_InputDoubleN(
    ...
    if not hasattr(ImGui_InputDoubleN, "func"):
        ...
        ImGui_InputDoubleN.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p, c_void_p, c_char_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_InputInt2(ctx, label, v1InOut, v2InOut, flagsInOptional=None):
    if not hasattr(ImGui_InputInt2, "func"):
        ...
        ImGui_InputInt2.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_InputInt3(ctx, label, v1InOut, v2InOut, v3InOut, flagsInOptional=None):
    if not hasattr(ImGui_InputInt3, "func"):
        ...
        ImGui_InputInt3.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_InputInt4(
    ctx, label, v1InOut, v2InOut, v3InOut, v4InOut, flagsInOptional=None
):
    if not hasattr(ImGui_InputInt4, "func"):
        proc = rpr_getfp("ImGui_InputInt4")
        ImGui_InputInt4.func = CFUNCTYPE(
...
def ImGui_InputText(
    ctx, label, bufInOutNeedBig, bufInOutNeedBig_sz, flagsInOptional=None
):
    if not hasattr(ImGui_InputText, "func"):
        proc = rpr_getfp("ImGui_InputText")
        ImGui_InputText.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_char_p, c_int, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        ...
        c_int(bufInOutNeedBig_sz),
        c_int(flagsInOptional) if flagsInOptional != None else None,
    )
    rval = ImGui_InputText.func(
        args[0], args[1], args[2], args[3], byref(args[4]) if args[4] != None else None
    )
    return rval, rpr_unpacks(args[2])
...
def ImGui_InputTextFlags_AllowTabInput():
    ...
    if not hasattr(ImGui_InputTextFlags_AllowTabInput, "cache"):
        ImGui_InputTextFlags_AllowTabInput.cache = (
            ImGui_InputTextFlags_AllowTabInput.func()
        )
...
def ImGui_InputTextFlags_AlwaysOverwrite():
    ...
    if not hasattr(ImGui_InputTextFlags_AlwaysOverwrite, "cache"):
        ImGui_InputTextFlags_AlwaysOverwrite.cache = (
            ImGui_InputTextFlags_AlwaysOverwrite.func()
        )
...
def ImGui_InputTextFlags_AutoSelectAll():
    ...
    if not hasattr(ImGui_InputTextFlags_AutoSelectAll, "cache"):
        ImGui_InputTextFlags_AutoSelectAll.cache = (
            ImGui_InputTextFlags_AutoSelectAll.func()
        )
...
def ImGui_InputTextFlags_CharsDecimal():
    ...
    if not hasattr(ImGui_InputTextFlags_CharsDecimal, "cache"):
        ImGui_InputTextFlags_CharsDecimal.cache = (
            ImGui_InputTextFlags_CharsDecimal.func()
        )
...
def ImGui_InputTextFlags_CharsHexadecimal():
    ...
    if not hasattr(ImGui_InputTextFlags_CharsHexadecimal, "cache"):
        ImGui_InputTextFlags_CharsHexadecimal.cache = (
            ImGui_InputTextFlags_CharsHexadecimal.func()
        )
...
def ImGui_InputTextFlags_CharsNoBlank():
    ...
    if not hasattr(ImGui_InputTextFlags_CharsNoBlank, "cache"):
        ImGui_InputTextFlags_CharsNoBlank.cache = (
            ImGui_InputTextFlags_CharsNoBlank.func()
        )
...
def ImGui_InputTextFlags_CharsScientific():
    ...
    if not hasattr(ImGui_InputTextFlags_CharsScientific, "cache"):
        ImGui_InputTextFlags_CharsScientific.cache = (
            ImGui_InputTextFlags_CharsScientific.func()
        )
...
def ImGui_InputTextFlags_CharsUppercase():
    ...
    if not hasattr(ImGui_InputTextFlags_CharsUppercase, "cache"):
        ImGui_InputTextFlags_CharsUppercase.cache = (
            ImGui_InputTextFlags_CharsUppercase.func()
        )
...
def ImGui_InputTextFlags_CtrlEnterForNewLine():
    ...
    if not hasattr(ImGui_InputTextFlags_CtrlEnterForNewLine, "cache"):
        ImGui_InputTextFlags_CtrlEnterForNewLine.cache = (
            ImGui_InputTextFlags_CtrlEnterForNewLine.func()
        )
...
def ImGui_InputTextFlags_EnterReturnsTrue():
    ...
    if not hasattr(ImGui_InputTextFlags_EnterReturnsTrue, "cache"):
        ImGui_InputTextFlags_EnterReturnsTrue.cache = (
            ImGui_InputTextFlags_EnterReturnsTrue.func()
        )
...
def ImGui_InputTextFlags_NoHorizontalScroll():
    ...
    if not hasattr(ImGui_InputTextFlags_NoHorizontalScroll, "cache"):
        ImGui_InputTextFlags_NoHorizontalScroll.cache = (
            ImGui_InputTextFlags_NoHorizontalScroll.func()
        )
...
def ImGui_InputTextMultiline(
    ...
    if not hasattr(ImGui_InputTextMultiline, "func"):
        ...
        ImGui_InputTextMultiline.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_char_p, c_int, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        rpr_packsc(label),
    ...
    rval = ImGui_InputTextMultiline.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def ImGui_InputTextWithHint(
    ctx, label, hint, bufInOutNeedBig, bufInOutNeedBig_sz, flagsInOptional=None
):
    if not hasattr(ImGui_InputTextWithHint, "func"):
        proc = rpr_getfp("ImGui_InputTextWithHint")
        ImGui_InputTextWithHint.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_char_p, c_char_p, c_int, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        rpr_packsc(label),
    ...
    rval = ImGui_InputTextWithHint.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def ImGui_InvisibleButton(ctx, str_id, size_w, size_h, flagsInOptional=None):
    if not hasattr(ImGui_InvisibleButton, "func"):
        ...
        ImGui_InvisibleButton.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_double, c_double, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
    ...
    rval = ImGui_InvisibleButton.func(
        args[0], args[1], args[2], args[3], byref(args[4]) if args[4] != None else None
    )
    return rval
...
def ImGui_IsKeyDown(ctx, key_code):
...
def ImGui_IsKeyPressed(ctx, key_code, repeatInOptional=None):
    ...
    rval = ImGui_IsKeyPressed.func(
        args[0], args[1], byref(args[2]) if args[2] != None else None
    )
    return rval


def ImGui_IsKeyReleased(ctx, key_code):
...
def ImGui_IsMouseClicked(ctx, button, repeatInOptional=None):
    ...
    rval = ImGui_IsMouseClicked.func(
        args[0], args[1], byref(args[2]) if args[2] != None else None
    )
    return rval
...
def ImGui_IsMouseDragging(ctx, button, lock_thresholdInOptional=None):
    ...
    rval = ImGui_IsMouseDragging.func(
        args[0], args[1], byref(args[2]) if args[2] != None else None
    )
    return rval


def ImGui_IsMouseHoveringRect(
    ctx, r_min_x, r_min_y, r_max_x, r_max_y, clipInOptional=None
):
    if not hasattr(ImGui_IsMouseHoveringRect, "func"):
        proc = rpr_getfp("ImGui_IsMouseHoveringRect")
        ImGui_IsMouseHoveringRect.func = CFUNCTYPE(
    ...
    rval = ImGui_IsMouseHoveringRect.func(
        args[0],
        args[1],
        args[2],
        args[3],
...
def ImGui_IsMousePosValid(ctx, mouse_pos_xInOptional=None, mouse_pos_yInOptional=None):
    if not hasattr(ImGui_IsMousePosValid, "func"):
        ...
        ImGui_IsMousePosValid.func = CFUNCTYPE(c_bool, c_void_p, c_void_p, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Context*", ctx),
    ...
    rval = ImGui_IsMousePosValid.func(
        args[0],
...
def ImGui_IsRectVisibleEx(ctx, rect_min_x, rect_min_y, rect_max_x, rect_max_y):
    if not hasattr(ImGui_IsRectVisibleEx, "func"):
        ...
        ImGui_IsRectVisibleEx.func = CFUNCTYPE(
...
def ImGui_IsWindowCollapsed(ctx):
    if not hasattr(ImGui_IsWindowCollapsed, "func"):
        proc = rpr_getfp("ImGui_IsWindowCollapsed")
        ImGui_IsWindowCollapsed.func = CFUNCTYPE(c_bool, c_void_p)(proc)
    args = (rpr_packp("ImGui_Context*", ctx),)
    rval = ImGui_IsWindowCollapsed.func(args[0])
    return rval
...
def ImGui_IsWindowFocused(ctx, flagsInOptional=None):
    ...
    rval = ImGui_IsWindowFocused.func(
        args[0], byref(args[1]) if args[1] != None else None
    )
    return rval
...
def ImGui_IsWindowHovered(ctx, flagsInOptional=None):
    ...
    rval = ImGui_IsWindowHovered.func(
        args[0], byref(args[1]) if args[1] != None else None
    )
    return rval


def ImGui_KeyModFlags_Alt():
    if not hasattr(ImGui_KeyModFlags_Alt, "func"):
        proc = rpr_getfp("ImGui_KeyModFlags_Alt")
        ImGui_KeyModFlags_Alt.func = CFUNCTYPE(c_int)(proc)
    if not hasattr(ImGui_KeyModFlags_Alt, "cache"):
        ImGui_KeyModFlags_Alt.cache = ImGui_KeyModFlags_Alt.func()
    return ImGui_KeyModFlags_Alt.cache


def ImGui_KeyModFlags_Ctrl():
    if not hasattr(ImGui_KeyModFlags_Ctrl, "func"):
        proc = rpr_getfp("ImGui_KeyModFlags_Ctrl")
        ImGui_KeyModFlags_Ctrl.func = CFUNCTYPE(c_int)(proc)
    if not hasattr(ImGui_KeyModFlags_Ctrl, "cache"):
        ImGui_KeyModFlags_Ctrl.cache = ImGui_KeyModFlags_Ctrl.func()
    return ImGui_KeyModFlags_Ctrl.cache


def ImGui_KeyModFlags_None():
    if not hasattr(ImGui_KeyModFlags_None, "func"):
        proc = rpr_getfp("ImGui_KeyModFlags_None")
        ImGui_KeyModFlags_None.func = CFUNCTYPE(c_int)(proc)
    if not hasattr(ImGui_KeyModFlags_None, "cache"):
        ImGui_KeyModFlags_None.cache = ImGui_KeyModFlags_None.func()
    return ImGui_KeyModFlags_None.cache


def ImGui_KeyModFlags_Shift():
    if not hasattr(ImGui_KeyModFlags_Shift, "func"):
        proc = rpr_getfp("ImGui_KeyModFlags_Shift")
        ImGui_KeyModFlags_Shift.func = CFUNCTYPE(c_int)(proc)
    if not hasattr(ImGui_KeyModFlags_Shift, "cache"):
        ImGui_KeyModFlags_Shift.cache = ImGui_KeyModFlags_Shift.func()
    return ImGui_KeyModFlags_Shift.cache


def ImGui_KeyModFlags_Super():
    if not hasattr(ImGui_KeyModFlags_Super, "func"):
        proc = rpr_getfp("ImGui_KeyModFlags_Super")
        ImGui_KeyModFlags_Super.func = CFUNCTYPE(c_int)(proc)
    if not hasattr(ImGui_KeyModFlags_Super, "cache"):
        ImGui_KeyModFlags_Super.cache = ImGui_KeyModFlags_Super.func()
    return ImGui_KeyModFlags_Super.cache
...
def ImGui_ListClipper_GetDisplayRange(
    clipper, display_startOut=None, display_endOut=None
):
    if not hasattr(ImGui_ListClipper_GetDisplayRange, "func"):
        proc = rpr_getfp("ImGui_ListClipper_GetDisplayRange")
        ImGui_ListClipper_GetDisplayRange.func = CFUNCTYPE(
            None, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_ListClipper*", clipper),
        c_int(display_startOut if display_startOut != None else 0),
        c_int(display_endOut if display_endOut != None else 0),
    )
...
def ImGui_MenuItem(
    ctx, label, p_selectedInOut, shortcutInOptional=None, enabledInOptional=None
):
    if not hasattr(ImGui_MenuItem, "func"):
        proc = rpr_getfp("ImGui_MenuItem")
        ImGui_MenuItem.func = CFUNCTYPE(
    ...
    args = (
        ...
        c_bool(p_selectedInOut),
        c_bool(enabledInOptional) if enabledInOptional != None else None,
    )
    rval = ImGui_MenuItem.func(
        args[0],
        args[1],
        args[2],
        byref(args[3]),
...
def ImGui_NumericLimits_Float(minOut=None, maxOut=None):
    ...
    args = (
        c_double(minOut if minOut != None else 0),
        c_double(maxOut if maxOut != None else 0),
    )
...
def ImGui_OpenPopupOnItemClick(ctx, str_idInOptional=None, popup_flagsInOptional=None):
    if not hasattr(ImGui_OpenPopupOnItemClick, "func"):
        ...
        ImGui_OpenPopupOnItemClick.func = CFUNCTYPE(None, c_void_p, c_char_p, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Context*", ctx),
    ...
    ImGui_OpenPopupOnItemClick.func(
        args[0], args[1], byref(args[2]) if args[2] != None else None
    )


def ImGui_PlotHistogram(
    ctx,
    label,
    values,
    ...
    if not hasattr(ImGui_PlotHistogram, "func"):
        ...
        ImGui_PlotHistogram.func = CFUNCTYPE(
            None,
            c_void_p,
            c_char_p,
            c_void_p,
...
def ImGui_PlotLines(
    ...
    if not hasattr(ImGui_PlotLines, "func"):
        ...
        ImGui_PlotLines.func = CFUNCTYPE(
            None,
            c_void_p,
            c_char_p,
            c_void_p,
...
def ImGui_PointConvertNative(ctx, xInOut, yInOut, to_nativeInOptional=None):
    if not hasattr(ImGui_PointConvertNative, "func"):
        ...
        ImGui_PointConvertNative.func = CFUNCTYPE(
...
def ImGui_PopAllowKeyboardFocus(ctx):
    if not hasattr(ImGui_PopAllowKeyboardFocus, "func"):
        proc = rpr_getfp("ImGui_PopAllowKeyboardFocus")
        ImGui_PopAllowKeyboardFocus.func = CFUNCTYPE(None, c_void_p)(proc)
    args = (rpr_packp("ImGui_Context*", ctx),)
    ImGui_PopAllowKeyboardFocus.func(args[0])
...
def ImGui_PopStyleColor(ctx, countInOptional=None):
    ...
    args = (
        rpr_packp("ImGui_Context*", ctx),
        c_int(countInOptional) if countInOptional != None else None,
    )
...
def ImGui_PopupFlags_MouseButtonMiddle():
    ...
    if not hasattr(ImGui_PopupFlags_MouseButtonMiddle, "cache"):
        ImGui_PopupFlags_MouseButtonMiddle.cache = (
            ImGui_PopupFlags_MouseButtonMiddle.func()
        )
...
def ImGui_PopupFlags_MouseButtonRight():
    ...
    if not hasattr(ImGui_PopupFlags_MouseButtonRight, "cache"):
        ImGui_PopupFlags_MouseButtonRight.cache = (
            ImGui_PopupFlags_MouseButtonRight.func()
        )
...
def ImGui_PopupFlags_NoOpenOverExistingPopup():
    ...
    if not hasattr(ImGui_PopupFlags_NoOpenOverExistingPopup, "cache"):
        ImGui_PopupFlags_NoOpenOverExistingPopup.cache = (
            ImGui_PopupFlags_NoOpenOverExistingPopup.func()
        )
...
def ImGui_ProgressBar(
    ...
    if not hasattr(ImGui_ProgressBar, "func"):
        ...
        ImGui_ProgressBar.func = CFUNCTYPE(
...
def ImGui_PushAllowKeyboardFocus(ctx, allow_keyboard_focus):
    if not hasattr(ImGui_PushAllowKeyboardFocus, "func"):
        proc = rpr_getfp("ImGui_PushAllowKeyboardFocus")
        ImGui_PushAllowKeyboardFocus.func = CFUNCTYPE(None, c_void_p, c_bool)(proc)
    args = (rpr_packp("ImGui_Context*", ctx), c_bool(allow_keyboard_focus))
    ImGui_PushAllowKeyboardFocus.func(args[0], args[1])
...
def ImGui_PushClipRect(
    ...
    if not hasattr(ImGui_PushClipRect, "func"):
        ...
        ImGui_PushClipRect.func = CFUNCTYPE(
...
def ImGui_PushStyleVar(ctx, var_idx, val1, val2InOptional=None):
    if not hasattr(ImGui_PushStyleVar, "func"):
        ...
        ImGui_PushStyleVar.func = CFUNCTYPE(None, c_void_p, c_int, c_double, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_RadioButtonEx(ctx, label, vInOut, v_button):
    if not hasattr(ImGui_RadioButtonEx, "func"):
        ...
        ImGui_RadioButtonEx.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_int
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_Selectable(
    ...
    if not hasattr(ImGui_Selectable, "func"):
        ...
        ImGui_Selectable.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_SelectableFlags_AllowDoubleClick():
    ...
    if not hasattr(ImGui_SelectableFlags_AllowDoubleClick, "cache"):
        ImGui_SelectableFlags_AllowDoubleClick.cache = (
            ImGui_SelectableFlags_AllowDoubleClick.func()
        )
...
def ImGui_SelectableFlags_AllowItemOverlap():
    ...
    if not hasattr(ImGui_SelectableFlags_AllowItemOverlap, "cache"):
        ImGui_SelectableFlags_AllowItemOverlap.cache = (
            ImGui_SelectableFlags_AllowItemOverlap.func()
        )
...
def ImGui_SelectableFlags_DontClosePopups():
    ...
    if not hasattr(ImGui_SelectableFlags_DontClosePopups, "cache"):
        ImGui_SelectableFlags_DontClosePopups.cache = (
            ImGui_SelectableFlags_DontClosePopups.func()
        )
...
def ImGui_SelectableFlags_SpanAllColumns():
    ...
    if not hasattr(ImGui_SelectableFlags_SpanAllColumns, "cache"):
        ImGui_SelectableFlags_SpanAllColumns.cache = (
            ImGui_SelectableFlags_SpanAllColumns.func()
        )
...
def ImGui_SetConfigFlags(ctx, flags):
    if not hasattr(ImGui_SetConfigFlags, "func"):
        proc = rpr_getfp("ImGui_SetConfigFlags")
        ImGui_SetConfigFlags.func = CFUNCTYPE(None, c_void_p, c_int)(proc)
    args = (rpr_packp("ImGui_Context*", ctx), c_int(flags))
    ImGui_SetConfigFlags.func(args[0], args[1])
...
def ImGui_SetCursorPos(ctx, local_pos_x, local_pos_y):
    ...
    args = (
        rpr_packp("ImGui_Context*", ctx),
        c_double(local_pos_x),
        c_double(local_pos_y),
    )
...
def ImGui_SetCursorScreenPos(ctx, pos_x, pos_y):
    if not hasattr(ImGui_SetCursorScreenPos, "func"):
        ...
        ImGui_SetCursorScreenPos.func = CFUNCTYPE(None, c_void_p, c_double, c_double)(
            proc
        )
...
def ImGui_SetDragDropPayload(ctx, type, data, condInOptional=None):
    if not hasattr(ImGui_SetDragDropPayload, "func"):
        ...
        ImGui_SetDragDropPayload.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_char_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
    ...
    rval = ImGui_SetDragDropPayload.func(
        args[0], args[1], args[2], byref(args[3]) if args[3] != None else None
    )
    return rval
...
def ImGui_SetKeyboardFocusHere(ctx, offsetInOptional=None):
    ...
    ImGui_SetKeyboardFocusHere.func(
        args[0], byref(args[1]) if args[1] != None else None
    )
...
def ImGui_SetNextWindowCollapsed(ctx, collapsed, condInOptional=None):
    if not hasattr(ImGui_SetNextWindowCollapsed, "func"):
        ...
        ImGui_SetNextWindowCollapsed.func = CFUNCTYPE(None, c_void_p, c_bool, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Context*", ctx),
    ...
    ImGui_SetNextWindowCollapsed.func(
        args[0], args[1], byref(args[2]) if args[2] != None else None
    )
...
def ImGui_SetNextWindowContentSize(ctx, size_w, size_h):
    if not hasattr(ImGui_SetNextWindowContentSize, "func"):
        ...
        ImGui_SetNextWindowContentSize.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double
        )(proc)
    args = (rpr_packp("ImGui_Context*", ctx), c_double(size_w), c_double(size_h))
...
def ImGui_SetNextWindowDockID(ctx, dock_id, condInOptional=None):
    if not hasattr(ImGui_SetNextWindowDockID, "func"):
        ...
        ImGui_SetNextWindowDockID.func = CFUNCTYPE(None, c_void_p, c_int, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Context*", ctx),
    ...
    ImGui_SetNextWindowDockID.func(
        args[0], args[1], byref(args[2]) if args[2] != None else None
    )
...
def ImGui_SetNextWindowPos(
    ...
    if not hasattr(ImGui_SetNextWindowPos, "func"):
        ...
        ImGui_SetNextWindowPos.func = CFUNCTYPE(
...
def ImGui_SetNextWindowSize(ctx, size_w, size_h, condInOptional=None):
    if not hasattr(ImGui_SetNextWindowSize, "func"):
        ...
        ImGui_SetNextWindowSize.func = CFUNCTYPE(
    ...
    ImGui_SetNextWindowSize.func(
        args[0], args[1], args[2], byref(args[3]) if args[3] != None else None
    )


def ImGui_SetNextWindowSizeConstraints(
    ctx, size_min_w, size_min_h, size_max_w, size_max_h
):
    if not hasattr(ImGui_SetNextWindowSizeConstraints, "func"):
        proc = rpr_getfp("ImGui_SetNextWindowSizeConstraints")
        ImGui_SetNextWindowSizeConstraints.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_double, c_double
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        c_double(size_min_w),
    ...
    ImGui_SetNextWindowSizeConstraints.func(args[0], args[1], args[2], args[3], args[4])
...
def ImGui_SetScrollFromPosX(ctx, local_x, center_x_ratioInOptional=None):
    if not hasattr(ImGui_SetScrollFromPosX, "func"):
        ...
        ImGui_SetScrollFromPosX.func = CFUNCTYPE(None, c_void_p, c_double, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_SetScrollFromPosY(ctx, local_y, center_y_ratioInOptional=None):
    if not hasattr(ImGui_SetScrollFromPosY, "func"):
        ...
        ImGui_SetScrollFromPosY.func = CFUNCTYPE(None, c_void_p, c_double, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_SetWindowCollapsed(ctx, collapsed, condInOptional=None):
    if not hasattr(ImGui_SetWindowCollapsed, "func"):
        ...
        ImGui_SetWindowCollapsed.func = CFUNCTYPE(None, c_void_p, c_bool, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_SetWindowCollapsedEx(ctx, name, collapsed, condInOptional=None):
    if not hasattr(ImGui_SetWindowCollapsedEx, "func"):
        ...
        ImGui_SetWindowCollapsedEx.func = CFUNCTYPE(
    ...
    ImGui_SetWindowCollapsedEx.func(
        args[0], args[1], args[2], byref(args[3]) if args[3] != None else None
    )
...
def ImGui_SetWindowPos(ctx, pos_x, pos_y, condInOptional=None):
    if not hasattr(ImGui_SetWindowPos, "func"):
        ...
        ImGui_SetWindowPos.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_SetWindowPosEx(ctx, name, pos_x, pos_y, condInOptional=None):
    if not hasattr(ImGui_SetWindowPosEx, "func"):
        ...
        ImGui_SetWindowPosEx.func = CFUNCTYPE(
...
def ImGui_SetWindowSize(ctx, size_w, size_h, condInOptional=None):
    if not hasattr(ImGui_SetWindowSize, "func"):
        ...
        ImGui_SetWindowSize.func = CFUNCTYPE(
            None, c_void_p, c_double, c_double, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_SetWindowSizeEx(ctx, name, size_w, size_h, condInOptional=None):
    if not hasattr(ImGui_SetWindowSizeEx, "func"):
        ...
        ImGui_SetWindowSizeEx.func = CFUNCTYPE(
            None, c_void_p, c_char_p, c_double, c_double, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
    ...
    ImGui_SetWindowSizeEx.func(
        args[0], args[1], args[2], args[3], byref(args[4]) if args[4] != None else None
    )


def ImGui_ShowMetricsWindow(ctx, p_openInOut):
    ...
    args = (rpr_packp("ImGui_Context*", ctx), c_bool(p_openInOut))
    ImGui_ShowMetricsWindow.func(args[0], byref(args[1]))
    return int(args[1].value)


def ImGui_SliderAngle(
    ctx,
    label,
    v_radInOut,
    ...
    if not hasattr(ImGui_SliderAngle, "func"):
        ...
        ImGui_SliderAngle.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_void_p, c_void_p, c_char_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_SliderDouble(
    ...
    if not hasattr(ImGui_SliderDouble, "func"):
        ...
        ImGui_SliderDouble.func = CFUNCTYPE(
...
def ImGui_SliderDouble2(
    ...
    if not hasattr(ImGui_SliderDouble2, "func"):
        ...
        ImGui_SliderDouble2.func = CFUNCTYPE(
            c_bool,
            c_void_p,
            c_char_p,
            c_void_p,
...
def ImGui_SliderDouble3(
    ...
    if not hasattr(ImGui_SliderDouble3, "func"):
        ...
        ImGui_SliderDouble3.func = CFUNCTYPE(
            c_bool,
            c_void_p,
            c_char_p,
            c_void_p,
...
def ImGui_SliderDouble4(
    ...
    if not hasattr(ImGui_SliderDouble4, "func"):
        ...
        ImGui_SliderDouble4.func = CFUNCTYPE(
            c_bool,
            c_void_p,
            c_char_p,
            c_void_p,
...
def ImGui_SliderDoubleN(
    ...
    if not hasattr(ImGui_SliderDoubleN, "func"):
        ...
        ImGui_SliderDoubleN.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_void_p, c_double, c_double, c_char_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_SliderFlags_NoRoundToFormat():
    ...
    if not hasattr(ImGui_SliderFlags_NoRoundToFormat, "cache"):
        ImGui_SliderFlags_NoRoundToFormat.cache = (
            ImGui_SliderFlags_NoRoundToFormat.func()
        )
...
def ImGui_SliderInt(
    ...
    if not hasattr(ImGui_SliderInt, "func"):
        ...
        ImGui_SliderInt.func = CFUNCTYPE(
...
def ImGui_SliderInt2(
    ...
    if not hasattr(ImGui_SliderInt2, "func"):
        ...
        ImGui_SliderInt2.func = CFUNCTYPE(
            c_bool,
            c_void_p,
            c_char_p,
            c_void_p,
...
def ImGui_SliderInt3(
    ...
    if not hasattr(ImGui_SliderInt3, "func"):
        ...
        ImGui_SliderInt3.func = CFUNCTYPE(
            c_bool,
            c_void_p,
            c_char_p,
            c_void_p,
...
def ImGui_SliderInt4(
    ...
    if not hasattr(ImGui_SliderInt4, "func"):
        ...
        ImGui_SliderInt4.func = CFUNCTYPE(
            c_bool,
            c_void_p,
            c_char_p,
            c_void_p,
...
def ImGui_StyleVar_SelectableTextAlign():
    ...
    if not hasattr(ImGui_StyleVar_SelectableTextAlign, "cache"):
        ImGui_StyleVar_SelectableTextAlign.cache = (
            ImGui_StyleVar_SelectableTextAlign.func()
        )
...
def ImGui_TabBarFlags_AutoSelectNewTabs():
    ...
    if not hasattr(ImGui_TabBarFlags_AutoSelectNewTabs, "cache"):
        ImGui_TabBarFlags_AutoSelectNewTabs.cache = (
            ImGui_TabBarFlags_AutoSelectNewTabs.func()
        )
...
def ImGui_TabBarFlags_FittingPolicyResizeDown():
    ...
    if not hasattr(ImGui_TabBarFlags_FittingPolicyResizeDown, "cache"):
        ImGui_TabBarFlags_FittingPolicyResizeDown.cache = (
            ImGui_TabBarFlags_FittingPolicyResizeDown.func()
        )
...
def ImGui_TabBarFlags_FittingPolicyScroll():
    ...
    if not hasattr(ImGui_TabBarFlags_FittingPolicyScroll, "cache"):
        ImGui_TabBarFlags_FittingPolicyScroll.cache = (
            ImGui_TabBarFlags_FittingPolicyScroll.func()
        )
...
def ImGui_TabBarFlags_NoCloseWithMiddleMouseButton():
    ...
    if not hasattr(ImGui_TabBarFlags_NoCloseWithMiddleMouseButton, "cache"):
        ImGui_TabBarFlags_NoCloseWithMiddleMouseButton.cache = (
            ImGui_TabBarFlags_NoCloseWithMiddleMouseButton.func()
        )
...
def ImGui_TabBarFlags_NoTabListScrollingButtons():
    ...
    if not hasattr(ImGui_TabBarFlags_NoTabListScrollingButtons, "cache"):
        ImGui_TabBarFlags_NoTabListScrollingButtons.cache = (
            ImGui_TabBarFlags_NoTabListScrollingButtons.func()
        )
...
def ImGui_TabBarFlags_TabListPopupButton():
    ...
    if not hasattr(ImGui_TabBarFlags_TabListPopupButton, "cache"):
        ImGui_TabBarFlags_TabListPopupButton.cache = (
            ImGui_TabBarFlags_TabListPopupButton.func()
        )
...
def ImGui_TabItemFlags_NoCloseWithMiddleMouseButton():
    ...
    if not hasattr(ImGui_TabItemFlags_NoCloseWithMiddleMouseButton, "cache"):
        ImGui_TabItemFlags_NoCloseWithMiddleMouseButton.cache = (
            ImGui_TabItemFlags_NoCloseWithMiddleMouseButton.func()
        )
...
def ImGui_TabItemFlags_UnsavedDocument():
    ...
    if not hasattr(ImGui_TabItemFlags_UnsavedDocument, "cache"):
        ImGui_TabItemFlags_UnsavedDocument.cache = (
            ImGui_TabItemFlags_UnsavedDocument.func()
        )
...
def ImGui_TableColumnFlags_DefaultHide():
    ...
    if not hasattr(ImGui_TableColumnFlags_DefaultHide, "cache"):
        ImGui_TableColumnFlags_DefaultHide.cache = (
            ImGui_TableColumnFlags_DefaultHide.func()
        )
...
def ImGui_TableColumnFlags_DefaultSort():
    ...
    if not hasattr(ImGui_TableColumnFlags_DefaultSort, "cache"):
        ImGui_TableColumnFlags_DefaultSort.cache = (
            ImGui_TableColumnFlags_DefaultSort.func()
        )
...
def ImGui_TableColumnFlags_IndentDisable():
    ...
    if not hasattr(ImGui_TableColumnFlags_IndentDisable, "cache"):
        ImGui_TableColumnFlags_IndentDisable.cache = (
            ImGui_TableColumnFlags_IndentDisable.func()
        )
...
def ImGui_TableColumnFlags_IndentEnable():
    ...
    if not hasattr(ImGui_TableColumnFlags_IndentEnable, "cache"):
        ImGui_TableColumnFlags_IndentEnable.cache = (
            ImGui_TableColumnFlags_IndentEnable.func()
        )
...
def ImGui_TableColumnFlags_NoHeaderWidth():
    ...
    if not hasattr(ImGui_TableColumnFlags_NoHeaderWidth, "cache"):
        ImGui_TableColumnFlags_NoHeaderWidth.cache = (
            ImGui_TableColumnFlags_NoHeaderWidth.func()
        )
...
def ImGui_TableColumnFlags_NoSortAscending():
    ...
    if not hasattr(ImGui_TableColumnFlags_NoSortAscending, "cache"):
        ImGui_TableColumnFlags_NoSortAscending.cache = (
            ImGui_TableColumnFlags_NoSortAscending.func()
        )
...
def ImGui_TableColumnFlags_NoSortDescending():
    ...
    if not hasattr(ImGui_TableColumnFlags_NoSortDescending, "cache"):
        ImGui_TableColumnFlags_NoSortDescending.cache = (
            ImGui_TableColumnFlags_NoSortDescending.func()
        )
...
def ImGui_TableColumnFlags_PreferSortAscending():
    ...
    if not hasattr(ImGui_TableColumnFlags_PreferSortAscending, "cache"):
        ImGui_TableColumnFlags_PreferSortAscending.cache = (
            ImGui_TableColumnFlags_PreferSortAscending.func()
        )
...
def ImGui_TableColumnFlags_PreferSortDescending():
    ...
    if not hasattr(ImGui_TableColumnFlags_PreferSortDescending, "cache"):
        ImGui_TableColumnFlags_PreferSortDescending.cache = (
            ImGui_TableColumnFlags_PreferSortDescending.func()
        )
...
def ImGui_TableColumnFlags_WidthFixed():
    ...
    if not hasattr(ImGui_TableColumnFlags_WidthFixed, "cache"):
        ImGui_TableColumnFlags_WidthFixed.cache = (
            ImGui_TableColumnFlags_WidthFixed.func()
        )
...
def ImGui_TableColumnFlags_WidthStretch():
    ...
    if not hasattr(ImGui_TableColumnFlags_WidthStretch, "cache"):
        ImGui_TableColumnFlags_WidthStretch.cache = (
            ImGui_TableColumnFlags_WidthStretch.func()
        )
...
def ImGui_TableFlags_ContextMenuInBody():
    ...
    if not hasattr(ImGui_TableFlags_ContextMenuInBody, "cache"):
        ImGui_TableFlags_ContextMenuInBody.cache = (
            ImGui_TableFlags_ContextMenuInBody.func()
        )
...
def ImGui_TableFlags_NoKeepColumnsVisible():
    ...
    if not hasattr(ImGui_TableFlags_NoKeepColumnsVisible, "cache"):
        ImGui_TableFlags_NoKeepColumnsVisible.cache = (
            ImGui_TableFlags_NoKeepColumnsVisible.func()
        )
...
def ImGui_TableFlags_SizingStretchProp():
    ...
    if not hasattr(ImGui_TableFlags_SizingStretchProp, "cache"):
        ImGui_TableFlags_SizingStretchProp.cache = (
            ImGui_TableFlags_SizingStretchProp.func()
        )
...
def ImGui_TableFlags_SizingStretchSame():
    ...
    if not hasattr(ImGui_TableFlags_SizingStretchSame, "cache"):
        ImGui_TableFlags_SizingStretchSame.cache = (
            ImGui_TableFlags_SizingStretchSame.func()
        )
...
def ImGui_TableGetColumnFlags(ctx, column_nInOptional=None):
    ...
    rval = ImGui_TableGetColumnFlags.func(
        args[0], byref(args[1]) if args[1] != None else None
    )
    return rval
...
def ImGui_TableGetColumnName(ctx, column_nInOptional=None):
    ...
    rval = ImGui_TableGetColumnName.func(
        args[0], byref(args[1]) if args[1] != None else None
    )
    return str(rval.decode())


def ImGui_TableGetColumnSortSpecs(
    ctx,
    id,
    column_user_idOut=None,
    column_indexOut=None,
    sort_orderOut=None,
    sort_directionOut=None,
):
    if not hasattr(ImGui_TableGetColumnSortSpecs, "func"):
        proc = rpr_getfp("ImGui_TableGetColumnSortSpecs")
        ImGui_TableGetColumnSortSpecs.func = CFUNCTYPE(
            c_bool, c_void_p, c_int, c_void_p, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
        c_int(id),
        c_int(column_user_idOut if column_user_idOut != None else 0),
        c_int(column_indexOut if column_indexOut != None else 0),
        c_int(sort_orderOut if sort_orderOut != None else 0),
        c_int(sort_directionOut if sort_directionOut != None else 0),
    )
    rval = ImGui_TableGetColumnSortSpecs.func(
        args[0], args[1], byref(args[2]), byref(args[3]), byref(args[4]), byref(args[5])
    )
    return (
        rval,
        int(args[2].value),
...
def ImGui_TableNeedSort(ctx, has_specsOut=None):
    ...
    args = (
        rpr_packp("ImGui_Context*", ctx),
        c_bool(has_specsOut if has_specsOut != None else 0),
    )
...
def ImGui_TableSetBgColor(ctx, target, color_rgba, column_nInOptional=None):
    if not hasattr(ImGui_TableSetBgColor, "func"):
        ...
        ImGui_TableSetBgColor.func = CFUNCTYPE(None, c_void_p, c_int, c_int, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_TableSetColumnEnabled(ctx, column_n, v):
    if not hasattr(ImGui_TableSetColumnEnabled, "func"):
        ...
        ImGui_TableSetColumnEnabled.func = CFUNCTYPE(None, c_void_p, c_int, c_bool)(
            proc
        )
...
def ImGui_TableSetupColumn(
    ...
    if not hasattr(ImGui_TableSetupColumn, "func"):
        ...
        ImGui_TableSetupColumn.func = CFUNCTYPE(
...
def ImGui_TableSetupScrollFreeze(ctx, cols, rows):
    if not hasattr(ImGui_TableSetupScrollFreeze, "func"):
        ...
        ImGui_TableSetupScrollFreeze.func = CFUNCTYPE(None, c_void_p, c_int, c_int)(
            proc
        )
...
def ImGui_TreeNodeEx(ctx, str_id, label, flagsInOptional=None):
    if not hasattr(ImGui_TreeNodeEx, "func"):
        ...
        ImGui_TreeNodeEx.func = CFUNCTYPE(
            c_bool, c_void_p, c_char_p, c_char_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Context*", ctx),
...
def ImGui_TreeNodeFlags_AllowItemOverlap():
    ...
    if not hasattr(ImGui_TreeNodeFlags_AllowItemOverlap, "cache"):
        ImGui_TreeNodeFlags_AllowItemOverlap.cache = (
            ImGui_TreeNodeFlags_AllowItemOverlap.func()
        )
...
def ImGui_TreeNodeFlags_CollapsingHeader():
    ...
    if not hasattr(ImGui_TreeNodeFlags_CollapsingHeader, "cache"):
        ImGui_TreeNodeFlags_CollapsingHeader.cache = (
            ImGui_TreeNodeFlags_CollapsingHeader.func()
        )
...
def ImGui_TreeNodeFlags_NoAutoOpenOnLog():
    ...
    if not hasattr(ImGui_TreeNodeFlags_NoAutoOpenOnLog, "cache"):
        ImGui_TreeNodeFlags_NoAutoOpenOnLog.cache = (
            ImGui_TreeNodeFlags_NoAutoOpenOnLog.func()
        )
...
def ImGui_TreeNodeFlags_NoTreePushOnOpen():
    ...
    if not hasattr(ImGui_TreeNodeFlags_NoTreePushOnOpen, "cache"):
        ImGui_TreeNodeFlags_NoTreePushOnOpen.cache = (
            ImGui_TreeNodeFlags_NoTreePushOnOpen.func()
        )
...
def ImGui_TreeNodeFlags_OpenOnDoubleClick():
    ...
    if not hasattr(ImGui_TreeNodeFlags_OpenOnDoubleClick, "cache"):
        ImGui_TreeNodeFlags_OpenOnDoubleClick.cache = (
            ImGui_TreeNodeFlags_OpenOnDoubleClick.func()
        )
...
def ImGui_TreeNodeFlags_SpanAvailWidth():
    ...
    if not hasattr(ImGui_TreeNodeFlags_SpanAvailWidth, "cache"):
        ImGui_TreeNodeFlags_SpanAvailWidth.cache = (
            ImGui_TreeNodeFlags_SpanAvailWidth.func()
        )
...
def ImGui_TreeNodeFlags_SpanFullWidth():
    ...
    if not hasattr(ImGui_TreeNodeFlags_SpanFullWidth, "cache"):
        ImGui_TreeNodeFlags_SpanFullWidth.cache = (
            ImGui_TreeNodeFlags_SpanFullWidth.func()
        )
...
def ImGui_VSliderDouble(
    ...
    if not hasattr(ImGui_VSliderDouble, "func"):
        ...
        ImGui_VSliderDouble.func = CFUNCTYPE(
            c_bool,
            c_void_p,
            c_char_p,
            c_double,
...
def ImGui_VSliderInt(
    ...
    if not hasattr(ImGui_VSliderInt, "func"):
        ...
        ImGui_VSliderInt.func = CFUNCTYPE(
            c_bool,
            c_void_p,
            c_char_p,
            c_double,
...
def ImGui_Viewport_GetCenter(viewport, xOut=None, yOut=None):
    if not hasattr(ImGui_Viewport_GetCenter, "func"):
        proc = rpr_getfp("ImGui_Viewport_GetCenter")
        ImGui_Viewport_GetCenter.func = CFUNCTYPE(None, c_void_p, c_void_p, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Viewport*", viewport),
        c_double(xOut if xOut != None else 0),
        c_double(yOut if yOut != None else 0),
    )
...
def ImGui_Viewport_GetPos(viewport, xOut=None, yOut=None):
...
def ImGui_Viewport_GetSize(viewport, wOut=None, hOut=None):
    if not hasattr(ImGui_Viewport_GetSize, "func"):
        proc = rpr_getfp("ImGui_Viewport_GetSize")
        ImGui_Viewport_GetSize.func = CFUNCTYPE(None, c_void_p, c_void_p, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Viewport*", viewport),
...
def ImGui_Viewport_GetWorkCenter(viewport, xOut=None, yOut=None):
    if not hasattr(ImGui_Viewport_GetWorkCenter, "func"):
        proc = rpr_getfp("ImGui_Viewport_GetWorkCenter")
        ImGui_Viewport_GetWorkCenter.func = CFUNCTYPE(
            None, c_void_p, c_void_p, c_void_p
        )(proc)
    args = (
        rpr_packp("ImGui_Viewport*", viewport),
...
def ImGui_Viewport_GetWorkPos(viewport, xOut=None, yOut=None):
    if not hasattr(ImGui_Viewport_GetWorkPos, "func"):
        proc = rpr_getfp("ImGui_Viewport_GetWorkPos")
        ImGui_Viewport_GetWorkPos.func = CFUNCTYPE(None, c_void_p, c_void_p, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Viewport*", viewport),
...
def ImGui_Viewport_GetWorkSize(viewport, wOut=None, hOut=None):
    if not hasattr(ImGui_Viewport_GetWorkSize, "func"):
        proc = rpr_getfp("ImGui_Viewport_GetWorkSize")
        ImGui_Viewport_GetWorkSize.func = CFUNCTYPE(None, c_void_p, c_void_p, c_void_p)(
            proc
        )
    args = (
        rpr_packp("ImGui_Viewport*", viewport),
...
def ImGui_WindowFlags_AlwaysAutoResize():
    ...
    if not hasattr(ImGui_WindowFlags_AlwaysAutoResize, "cache"):
        ImGui_WindowFlags_AlwaysAutoResize.cache = (
            ImGui_WindowFlags_AlwaysAutoResize.func()
        )
...
def ImGui_WindowFlags_AlwaysHorizontalScrollbar():
    ...
    if not hasattr(ImGui_WindowFlags_AlwaysHorizontalScrollbar, "cache"):
        ImGui_WindowFlags_AlwaysHorizontalScrollbar.cache = (
            ImGui_WindowFlags_AlwaysHorizontalScrollbar.func()
        )
...
def ImGui_WindowFlags_AlwaysUseWindowPadding():
    ...
    if not hasattr(ImGui_WindowFlags_AlwaysUseWindowPadding, "cache"):
        ImGui_WindowFlags_AlwaysUseWindowPadding.cache = (
            ImGui_WindowFlags_AlwaysUseWindowPadding.func()
        )
...
def ImGui_WindowFlags_AlwaysVerticalScrollbar():
    ...
    if not hasattr(ImGui_WindowFlags_AlwaysVerticalScrollbar, "cache"):
        ImGui_WindowFlags_AlwaysVerticalScrollbar.cache = (
            ImGui_WindowFlags_AlwaysVerticalScrollbar.func()
        )
...
def ImGui_WindowFlags_HorizontalScrollbar():
    ...
    if not hasattr(ImGui_WindowFlags_HorizontalScrollbar, "cache"):
        ImGui_WindowFlags_HorizontalScrollbar.cache = (
            ImGui_WindowFlags_HorizontalScrollbar.func()
        )
...
def ImGui_WindowFlags_NoFocusOnAppearing():
    ...
    if not hasattr(ImGui_WindowFlags_NoFocusOnAppearing, "cache"):
        ImGui_WindowFlags_NoFocusOnAppearing.cache = (
            ImGui_WindowFlags_NoFocusOnAppearing.func()
        )
...
def ImGui_WindowFlags_NoSavedSettings():
    ...
    if not hasattr(ImGui_WindowFlags_NoSavedSettings, "cache"):
        ImGui_WindowFlags_NoSavedSettings.cache = (
            ImGui_WindowFlags_NoSavedSettings.func()
        )
...
def ImGui_WindowFlags_NoScrollWithMouse():
    ...
    if not hasattr(ImGui_WindowFlags_NoScrollWithMouse, "cache"):
        ImGui_WindowFlags_NoScrollWithMouse.cache = (
            ImGui_WindowFlags_NoScrollWithMouse.func()
        )
...
def ImGui_WindowFlags_UnsavedDocument():
    ...
    if not hasattr(ImGui_WindowFlags_UnsavedDocument, "cache"):
        ImGui_WindowFlags_UnsavedDocument.cache = (
            ImGui_WindowFlags_UnsavedDocument.func()
        )
